<%-- 
    ...
    Created on : Jun 15, 2020, 7:41:24 PM
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <!--              Spring forms tag - includes additional features
                                modelAttribute = key name for the object we want to grab (added attribute in controller)
                                input path attribute - indicates property name-->
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <sf:errors path="phone" cssclass="error"></sf:errors>
                            <!--                        must have contact id there, so we keep it hidden -->
                        <sf:hidden path="contactId"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-4 col-md-8">
                        <!--                       not SF! just regular submit -->
