 ...
 */
@ControllerAdvice //advice that is to be applied to all controllers in this application
public class ControllerExceptionHandler {
    //POJO
    //Since these methods handle exceptions for REST endpoint methods, 
    //they can return data and an HTTP status code.
